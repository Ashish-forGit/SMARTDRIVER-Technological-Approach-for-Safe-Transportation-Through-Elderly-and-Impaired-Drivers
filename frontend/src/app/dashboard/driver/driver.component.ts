...
export class DriverComponent {
  ...
  ngOnInit(): void {
    ...
    this.driverForm = this.formBuilder.group({
      ...
      status: [""],
      drivinglicense: ["", [Validators.required]], // ✅ Add this
      aadharcard: ["", [Validators.required, Validators.pattern(/^[0-9]{12}$/)]], // ✅ added
    });
  ...
  AddDriver() {
    ...
    formData.append("drivinglicense", this.driverForm.value.drivinglicense);
    formData.append("aadharcard", this.driverForm.get("aadharcard")?.value);
